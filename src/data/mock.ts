...
export const vehicles:Vehicle[]=[
 {id:'bmw-320d',vin:'WBA8K91070K123456',make:'BMW',model:'320d Touring',trim:'M Sport · G21',year:2020,mileage:87420,fuelType:'Diesel',power:'190 hp',transmission:'Automatic',registration:'ZH 482 913',image:new URL('../assets/bmw-320d.png',import.meta.url).href,health:'Up to date',ownershipStatus:'Current',ownershipSince:'June 2023',firstRegistration:'14 February 2020'},
...
export const maintenance:MaintenanceItem[]=[
 ...
 {id:'pads',name:'Front brake pads',status:'Due soon',dueDate:'Workshop recommendation',last:'12 October 2025',interval:'Inspect at each service',why:'Garage Jerala observed wear and recommends an inspection within 3,000 km.'},
